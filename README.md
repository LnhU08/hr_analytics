...
* `employee_info.csv`: Tập dữ liệu thô chứa thông tin chi tiết của 10,000 nhân viên.
* `Data Dictionary.xlsx`: Từ điển dữ liệu giải thích chi tiết ý nghĩa của các trường thông tin bằng hai ngôn ngữ Anh - Việt.
